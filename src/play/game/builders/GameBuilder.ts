...
export class GameBuilder {
    ...
    private dragEnd = (piece: any) => {
        if (!this.isGameFinished) this.gameLogic.checkPieces(piece.logic);

        piece.logic.isDragging = false;

        piece.logic.set.forEach((item: PieceLogic) => {
